...
public class FontConverter : TypeConverter
{
    ...
    /// <summary>
    /// <see cref='FontConverter.FontNameConverter'/> is a type converter that is used
    ...
    private sealed class FontNameConverter : TypeConverter
    {
        ...
        /// </summary>
        /// <param name="context">
        /// An <see cref='System.ComponentModel.ITypeDescriptorContext'/> that can be used to extract additional
        ...
        /// may return null.
        /// </param>
        /// <param name="culture">A <see cref='System.Globalization.CultureInfo'/> to use to perform the conversion</param>
        ...
        /// may return null.
        /// </param>
        /// <returns>true if the collection returned from <see cref='FontConverter.FontNameConverter.GetStandardValues'/>
        /// is an exclusive list of possible values; otherwise, false. The default is false.</returns>
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref='FontConverter.FontUnitConverter'/> class.
        /// </summary>
    ...
    /// </summary>
    /// <param name="context">An <see cref='System.ComponentModel.ITypeDescriptorContext'/> object that provides a format context.</param>
    /// <param name="destinationType">A <see cref='System.Type'/> object that represents the type you want to convert to.</param>
    ...
    /// pairs, one for each property returned from the <see cref='FontConverter.GetProperties'/>
    /// method.
    /// </param>
    /// <returns>
    ...
    /// <see cref='FontConverter.CreateInstance'/> method to create a new value.
    /// </summary>
    /// <param name="context">A type descriptor through which additional context can be provided.</param>
    /// <returns>
